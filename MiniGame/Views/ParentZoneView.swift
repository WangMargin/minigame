        ...
        ZStack {
            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    // --- 时长控制 ---
                    settingsCard(title: "⏱️ 每日时长限制", systemImage: "hourglass") {
                        VStack(spacing: 16) {
                            HStack {
                    ...
                    // --- 音效控制 ---
                    settingsCard(title: "🔊 音效设置", systemImage: "speaker.wave.2") {
                        VStack(spacing: 14) {
                    ...
                    // --- 学习进度 ---
                    settingsCard(title: "📊 学习进度", systemImage: "chart.bar.fill") {
                        VStack(spacing: 14) {
                            progressRow("总星星数", value: "\(gameVM.totalStars) ⭐")
                    ...
                    // --- 重置 ---
                    settingsCard(title: "🔄 数据管理", systemImage: "arrow.triangle.2.circlepath") {
