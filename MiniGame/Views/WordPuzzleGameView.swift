...
struct WordPuzzleData {
    ...
    static func pool(for age: AgeGroup) -> [WordPuzzleData] {
        switch age {
        case .child:  // 6-8岁: 简单3-4字母单词
            return [
                WordPuzzleData(word: "CAT", hint: "喵喵叫的小动物", emoji: "🐱"),
                WordPuzzleData(word: "DOG", hint: "汪汪叫的好朋友", emoji: "🐶"),
                WordPuzzleData(word: "SUN", hint: "天上的发光体", emoji: "☀️"),
                WordPuzzleData(word: "FISH", hint: "在水里游", emoji: "🐟"),
                WordPuzzleData(word: "BIRD", hint: "会飞的小动物", emoji: "🐦"),
                WordPuzzleData(word: "BOOK", hint: "用来读的", emoji: "📖"),
                WordPuzzleData(word: "STAR", hint: "夜空中一闪一闪", emoji: "⭐"),
                WordPuzzleData(word: "TREE", hint: "公园里有很多", emoji: "🌳"),
                WordPuzzleData(word: "MOON", hint: "晚上在天上", emoji: "🌙"),
                WordPuzzleData(word: "RAIN", hint: "从云里掉下来的水", emoji: "🌧️"),
            ]
        case .preteen:  // 9-12岁: 5-6字母单词
            return [
                WordPuzzleData(word: "APPLE", hint: "一种红色或绿色的水果", emoji: "🍎"),
                WordPuzzleData(word: "HOUSE", hint: "我们住在里面", emoji: "🏠"),
                WordPuzzleData(word: "WATER", hint: "生命之源", emoji: "💧"),
                WordPuzzleData(word: "MUSIC", hint: "用耳朵听的艺术", emoji: "🎵"),
                WordPuzzleData(word: "PLANE", hint: "在天上飞的交通工具", emoji: "✈️"),
                WordPuzzleData(word: "HAPPY", hint: "开心的心情", emoji: "😊"),
                WordPuzzleData(word: "DREAM", hint: "睡觉时脑海里的事", emoji: "💭"),
                WordPuzzleData(word: "LIGHT", hint: "照亮黑暗的东西", emoji: "💡"),
                WordPuzzleData(word: "OCEAN", hint: "很大很大的海", emoji: "🌊"),
                WordPuzzleData(word: "TIGER", hint: "森林里的条纹大猫", emoji: "🐯"),
                WordPuzzleData(word: "EARTH", hint: "我们生活的星球", emoji: "🌍"),
                WordPuzzleData(word: "SMILE", hint: "开心时的表情", emoji: "😄"),
            ]
        default: return []
        }
    }
